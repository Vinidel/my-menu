...
├── docs/                ← briefs/, critique.md, implementation-notes.md, hardening-notes.md, employee-auth.md, employee-orders-dashboard.md, admin-orders-dashboard-ux-mobile-and-status-sorting.md, admin-orders-dashboard-polling-tanstack-query.md, customer-order-submission.md, api-orders-anti-abuse.md, order-item-extras-customization.md (feature docs)
